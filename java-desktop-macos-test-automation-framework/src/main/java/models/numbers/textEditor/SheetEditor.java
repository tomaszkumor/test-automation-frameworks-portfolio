...
public class SheetEditor extends SheetEditorLocators {
    public SheetEditor() {
        check.isElementDisplayed(toolbar, 15);
        log.info("New document window has been displayed.");
    }

    public SheetEditor hideDocumentOptions() {
    ...
    @Step("Check scale")
    public SheetEditor checkScale(DesktopModel desktopModel) {
    ...
    public SheetEditor clickOnDocumentNameLabel() {
    ...
    public SheetEditor checkDocumentNameBeforeEdit() {
    ...
    public SheetEditor checkDocumentNameAfterEdit(DesktopModel desktopModel) {
